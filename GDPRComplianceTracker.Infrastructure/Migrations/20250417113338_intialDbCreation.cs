...
namespace GDPRComplianceTracker.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DataActivities_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurposeOfSharing = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DataShared = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ContractInPlace = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExternalPartners", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExternalPartners_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SystemStorages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SystemStorages_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataActivities_CompanyId",
                table: "DataActivities",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ExternalPartners_CompanyId",
                table: "ExternalPartners",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_SystemStorages_CompanyId",
